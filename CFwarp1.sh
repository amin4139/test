...
ABC1=$c5 && ABC2=$c2 && ABC3=$ud4 && ABC4=$c4 && WGCFins
fi
if [[ -n $v6 && -z $v4 ]]; then
...
conf && ABC1=$c5 && ABC2=$c2 && ABC3=$ud4 && ABC4=$c4 && ABC
fi
if [[ -n $v6 && -z $v4 ]]; then
...
ABC1=$c5 && ABC2=$c1 && ABC3=$ud6 && ABC4=$c4 && WGCFins
fi
if [[ -n $v6 && -z $v4 ]]; then
...
conf && ABC1=$c5 && ABC2=$c1 && ABC3=$ud6 && ABC4=$c4 && ABC
fi
if [[ -n $v6 && -z $v4 ]]; then
...
STOPwgcf ; ABC1=$c5 && ABC2=$ud4ud6 && ABC3=$c4 && WGCFins
fi
if [[ -n $v6 && -z $v4 ]]; then
green "当前原生v6单栈vps首次安装wgcf-warp\n现添加IPV4+IPV6双栈wgcf-warp模式" && sleep 2
...
STOPwgcf ; conf && ABC1=$c5 && ABC2=$ud4ud6 && ABC3=$c4 && ABC
fi
if [[ -n $v6 && -z $v4 ]]; then
green "当前原生v6单栈vps已安装wgcf-warp\n现快速切换IPV4+IPV6双栈wgcf-warp模式" && sleep 2
