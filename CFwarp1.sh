...
wpygV="22.8.25 V 0.1"
remoteV=`wget -qO- https://gitlab.com/rwkgyg/CFwarp/raw/main/CFwarp1.sh | sed -n 4p | cut -d '"' -f 2`
red='\033[0;31m'
bblue='\033[0;34m'
yellow='\033[0;33m'
green='\033[0;32m'
...
c4="sed -i 's/engage.cloudflareclient.com/2606:4700:100::a29f:c001/g' /etc/wireguard/wgcf.conf"
