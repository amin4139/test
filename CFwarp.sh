...
L46
ud4='sed -i "4 s/^/PostUp = ip -4 rule add from '$L4' lookup main\n/;5 s/^/PostDown = ip -4 rule delete from '$L4' lookup main\n/" /etc/wireguard/wgcf.conf'
ud6='sed -i "6 s/^/PostUp = ip -6 rule add from '$L6' lookup main\n/;7 s/^/PostDown = ip -6 rule delete from '$L6' lookup main\n/" /etc/wireguard/wgcf.conf'
ud4ud6='sed -i "4 s/^/PostUp = ip -4 rule add from '$L4' lookup main\n/;5 s/^/PostDown = ip -4 rule delete from '$L4' lookup main\n/;6 s/^/PostUp = ip -6 rule add from '$L6' lookup main\n/;7 s/^/PostDown = ip -6 rule delete from '$L6' lookup main\n/" /etc/wireguard/wgcf.conf'
